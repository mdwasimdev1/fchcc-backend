...
<!-- Mirrored from hexabox.dexignlab.com/xhtml/page-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Jan 2026 20:51:38 GMT -->
...
<head>
    ...
    <meta name="keywords" content="HexaBox, Bootstrap admin template, multipurpose admin dashboard, responsive dashboard UI, web app admin panel, analytics dashboard, Bootstrap 5 template, HTML admin UI, admin panel design, modern dashboard template, SaaS dashboard, CRM admin UI">
    <meta name="description" content="HexaBox is a powerful Multipurpose Bootstrap Admin Dashboard Template designed for web applications, analytics, CRM, and SaaS platforms. Fully responsive, customizable, and packed with modern UI components.">

    <!-- OPENGRAPH META -->
    <meta property="og:title" content="HexaBox – Multipurpose Bootstrap Admin Dashboard Template">
    <meta property="og:description" content="HexaBox is a versatile and responsive Bootstrap admin dashboard template, perfect for analytics, CRM systems, and backend web interfaces.">
    ...
    <meta name="twitter:description" content="Create high-performing dashboards with HexaBox – a responsive and feature-rich Bootstrap admin template for all kinds of web apps.">
            ...
            <div class="col-xl-6 col-lg-6 mx-auto align-self-center">
                <div class="auth-form">
                    <div class="text-center mb-4">
                        <h3 class="mb-0">Sign up your account</h3>
                        <p class="mb-0">Create an account and start your journey today!</p>
                    </div>
                    <form method="POST" action="{{ route('register') }}">
                        @csrf
                        <div class="mb-3">
                            <label for="name" class="form-label">Username</label>
                            <input id="name" name="name" type="text" :value="old('name')" required autofocus autocomplete="name" class="form-control form-control-lg" placeholder="e.g. John Joe">
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" id="email" type="email" name="email" :value="old('email')" required autocomplete="username" class="form-control form-control-lg" placeholder="hello@example.com">
                        </div>
                        <div class="mb-3">
                            <label  for="password" class="form-label">Password</label>
                            <div class="position-relative">
                                <input id="password" type="password" name="password" required autocomplete="new-password" type="password" autocomplete="new-password" class="form-control form-control-lg ic-password" placeholder="Enter your password">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="position-relative">
                                <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password" type="password" autocomplete="new-password" class="form-control form-control-lg ic-password" placeholder="Enter your password">
                                <span class="show-pass position-absolute top-50 end-0 me-2 translate-middle">
                                    <span class="show"><i class="fa fa-eye-slash"></i></span>
                                    <span class="hide"><i class="fa fa-eye"></i></span>
                                </span>
                        ...
                        <div class="text-center border-bottom border-grey position-relative my-3">
                            <span class="small bg-body-secondary position-absolute top-50 start-50 translate-middle px-2 ">Or continue with</span>
                        </div>
                        <div class="d-flex align-self-center justify-content-center gap-2 py-3">
                            <a target="_blank" href="https://www.facebook.com/" class="btn btn-sm btn-facebook btn-square rounded-circle"><i class="fab fa-facebook-f"></i></a>
                            <a target="_blank" href="https://www.google.com/" class="btn btn-sm btn-google btn-square rounded-circle"><i class="fab fa-google"></i></a>
                            <a target="_blank" href="https://twitter.com/" class="btn btn-sm btn-twitter btn-square rounded-circle"><i class="fab fa-x-twitter"></i></a>
                            <a target="_blank" href="https://www.linkedin.com/" class="btn btn-sm btn-linkedin btn-square rounded-circle"><i class="fab fa-linkedin-in"></i></a>
                        </div>
