...
<!-- Mirrored from hexabox.dexignlab.com/xhtml/page-forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Jan 2026 20:51:47 GMT -->
            ...
            <div class="col-xl-6 col-lg-6 mx-auto align-self-center">
                <div class="auth-form">
                    <div class="text-center mb-4">
                        ...
                        <p class="mb-0">Recover access to your account quickly and easily!</p>
                    </div>
                    <form method="POST" action="{{ route('password.email') }}">
                        @csrf
                        <div class="mb-4">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" id="email" type="email" name="email" :value="old('email')" required autofocus class="form-control form-control-lg" placeholder="hello@example.com">
                        </div>
                        
                        <div class="text-center mb-4">
                            <button type="submit" class="btn btn-primary btn-lg w-100 mb-3">Email Password Reset Link</button>
                        </div>
