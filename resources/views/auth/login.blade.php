                ...
                <div class="col-xl-6 col-lg-6 order-lg-1">
                    <div class="auth-info text-center">
                        <div class="mb-5 mx-auto col-xxl-6">
                            ...
                            <p class="info-text">The CRM dashboard visualizes customer-related metrics and trends over time, providing valuable insights for better decision-making.</p>
                        </div>
                    ...
                    <div class="auth-form">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="email" name="email" type="email" class="form-control form-control-lg" required autofocus autocomplete="username" placeholder="username">
                            </div>
                            <div class="mb-3">
                                <label for="password" class="form-label">Password</label>
                                <div class="position-relative">
                                    <input type="password" id="password" name="password" required autocomplete="current-password" class="form-control form-control-lg ic-password" placeholder="Enter your password">
                            ...
                            <div class="d-flex gap-2 flex-wrap justify-content-between mb-4 mb-lg-5">
                                <div class="form-check custom-checkbox mb-0">
                                    <input type="checkbox" id="remember_me" name="remember" class="form-check-input" id="customCheckBox1">
                                    <label for="remember_me" class="form-check-label" for="customCheckBox1">Remember me</label>
                                </div>
                                <a href="{{ route('password.email') }}" class="btn-link text-primary">Forgot Password?</a>
                            </div>
                            <div class="text-center mb-4">
                            ...
                            <div class="d-flex align-self-center justify-content-center gap-2 py-3">
                                ...
                                <a  href="{{ route('google.login') }}" class="btn btn-sm btn-google btn-square rounded-circle"><i class="fab fa-google"></i></a>
