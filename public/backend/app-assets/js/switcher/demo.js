...
(function($) {	
	...
	jQuery(document).on('click', '.ic_theme_demo', function(){
		...
		jQuery('.main-switcher').attr('href','backend/app-assets/css/switcher.css');
		jQuery('.main-plugins').attr('href','backend/app-assets/css/plugins.css');
		jQuery('.main-css').attr('href','backend/app-assets/css/style.css');
	});
	...
	jQuery(document).on('click', '.ic_theme_demo_rtl', function(){
		...
		$('.ic-demo-panel').removeClass('show');
		jQuery('.main-switcher').attr('href','backend/app-assets/css/switcher-rtl.css');
		jQuery('.main-plugins').attr('href','backend/app-assets/css/plugins-rtl.css');
		jQuery('.main-css').attr('href','backend/app-assets/css/style-rtl.css');
	});
